from src.quantum.params import KYBER_N, KYBER_Q, KYBER_POLY_COMPRESSED_BYTES_768, \
...
from src.quantum.util import conditional_subq, cast_to_byte, cast_to_short, cast_to_int32, cast_to_long64, \
    cbd, montgomery_reduce, barrett_reduce
from src.quantum.prf import generate_prf_byte_array
from src.quantum.ntt import ntt, inv_ntt, base_multiplier, NTT_ZETAS

def poly_conditional_subq(r):
    """
    subtract KYBER_Q from each coefficient from src.quantum.polynomial r
    :param r:
    :return:
    """
...
def poly_sub(poly_a, poly_b):
    """
    subtract poly_b from src.quantum.poly_a
    :param poly_a: short array
    :param poly_b: short array
    :return: short array
    """
